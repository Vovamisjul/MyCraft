...
DiamondAxe::DiamondAxe(string path, const GLchar* vertexPath, const GLchar* fragmentPath) : CommonModel::CommonModel(path, vertexPath, fragmentPath)
{

}

void DiamondAxe::draw(Player *player, World *world)
{
...
void DiamondAxe::drawInNetPlayer(Player *player, NetPlayer *netPlayer, World *World)
{
