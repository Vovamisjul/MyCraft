...
class WorkBench : public Shader {
public:
	GLuint texInv;
	WorkBench(const GLchar* vertexPath, const GLchar* fragmentPath);
	void draw();
...
private:
	...
	GLuint VAOinvcraft[10], VBOinvcraft[10], EBOinvcraft[10];

	float craftVerticesInv[20] = {
		// Positions          // Colors           // Texture Coords
		-0.35f, 0.77f, 0.0f,  1.0f, 1.0f, // Top Right
		-0.35f, 0.58f, 0.0f,  1.0f, 0.0f, // Bottom Right 
		-0.48f, 0.58f, 0.0f,  0.0f, 0.0f, // Bottom Left
		-0.48f, 0.77f, 0.0f,   0.0f, 1.0f  // Top Left 
	};
